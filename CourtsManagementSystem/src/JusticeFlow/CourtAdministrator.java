...
public class CourtAdministrator extends User {
    ...
    public void closeCase(List<Case> AllCases, FileHandler fileHandler, DatabaseHandler dbHandler, Stage primaryStage,
            Scene previousScene) {
        // Title Label
        ...
        // Iterate over all cases and add only pending cases
        for (Case cases : AllCases) {
            if ("Opened".equalsIgnoreCase(cases.getCaseStatus())) {
                ...
                // Approve and Reject Buttons
                Button approveButton = new Button("Close");
                approveButton.setStyle(
                        "-fx-background-color: #27ae60; " +
                                "-fx-text-fill: white; " +
                                "-fx-font-size: 14px; " +
